...
const active = computed(() =>
  route.path.startsWith("/profile")
    ...
    : route.path.startsWith("/releases")
      ? "/releases"
      : route.path.startsWith("/feedback")
        ? "/feedback"
        : route.path,
);
  ...
  <a-layout class="shell">
    ...
    >
      <div class="brand" :class="{ compact: collapsed }">
        <img class="brand-logo" :src="gotapLogo" alt="GoTap" />
        <span>GoTap 管理</span>
      </div>
      <a-menu
        theme="dark"
      ...
      >
        <a-menu-item key="/dashboard"
          ><AppstoreOutlined /><span>运行总览</span></a-menu-item
        >
        <a-menu-item key="/users"
          ><TeamOutlined /><span>用户管理</span></a-menu-item
        >
        <a-menu-item key="/releases"
          ><RocketOutlined /><span>版本发布</span></a-menu-item
        >
        <a-menu-item key="/feedback"
          ><MessageOutlined /><span>问题反馈</span></a-menu-item
        >
        <a-menu-divider />
        <a-menu-item key="/settings"
          ><SettingOutlined /><span>系统设置</span></a-menu-item
        >
      </a-menu>
    </a-layout-sider>
    ...
    <a-layout class="main-layout" :class="{ 'is-collapsed': collapsed }">
      <a-layout-header class="header">
        <div class="header-left">
          ...
          <a-breadcrumb
            ...
            ><a-breadcrumb-item>{{ title }}</a-breadcrumb-item></a-breadcrumb
          >
        </div>
      ...
      <div class="page-tabs">
        <a-tag class="page-tab" color="blue">{{ title }}</a-tag>
      </div>
  ...
  >
    <a-form layout="vertical"
      ...
      ><a-form-item label="内容区域"
        ><a-switch
          checked-children="铺满"
          un-checked-children="定宽" /></a-form-item
    ></a-form>
  </a-drawer>
</template>
